...
public class MainReturnActivity extends AppCompatActivity{
        ...
        mEdtID.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                if(!mSwtUsePhone.isChecked()){
                    ...
                    if(l!=0) { mBtnOK.setEnabled(true);}
                    else { mBtnOK.setEnabled(false);}
                }
            }
        });
    ...
    /*
    private View.OnFocusChangeListener edtPhoneFocusChange = new View.OnFocusChangeListener() {
        @Override
    ...
    /*
    private View.OnFocusChangeListener edtIDFocusChange = new View.OnFocusChangeListener() {
        @Override
        public void onFocusChange(View v, boolean hasFocus) {
            if(hasFocus){
                InputMethodManager keyboard = (InputMethodManager)getSystemService(Activity.INPUT_METHOD_SERVICE);
